...
# The results are mostly as expected. The binary search line shows a but mostly logarithmic time 
# complexity, which matches with the expected time complexity of O(log(n)).
